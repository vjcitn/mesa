...
- Some vignette prose contains concrete wording problems that interrupt the scientific narrative and tutorial flow: line 24 uses an infinitive incorrectly, line 32 omits the auxiliary needed for a passive construction, and line 43 contains an unnecessary extra verb (`vignettes/introduction.Rmd:24,32,43`).
