...
- Some vignette prose contains concrete wording problems that interrupt the scientific narrative and tutorial flow, including source phrasing like “designed to introduction”, “Once this step has performed”, and “this is only includes”; these lines would read more cleanly as “designed as an introduction”, “Once this step has been performed”, and “this only includes” (`vignettes/introduction.Rmd:24,32,43`).
