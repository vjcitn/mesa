...
- Some vignette prose contains concrete wording problems that interrupt the scientific narrative and tutorial flow: the phrase “designed to introduction” should read “designed as an introduction”, “Once this step has performed” should read “Once this step has been performed”, and “this is only includes” should read “this includes only” (`vignettes/introduction.Rmd:24,32,43`).
