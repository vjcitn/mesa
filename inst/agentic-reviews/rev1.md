...
- Some vignette prose in the introduction vignette needs routine proofreading for grammar and sentence flow, and this weakens an otherwise strong user-facing scientific narrative (`vignettes/introduction.Rmd:24,32,43`).
